...
rem Adicionada a exceção da pasta "Alfa Laval" para quem sincroniza do Sharepoint		- 22/11/2022 3.9
rem Adicionada a exceção da pasta "qBittorrent" para manter os torrents				- 28/06/2025 4.0
...
ECHO 										Created by MFMMENEGHIN V.4.0
ECHO ***************************************************************************************************************
Echo.
...
ROBOCOPY "%appdata%\qBittorrent" "%dsk%\Backup\%COMPUTERNAME%\Users\%USERNAME%.BKP\AppData\Roaming\qBittorrent" /E /R:1 /W:0 /XJ /ZB
...
ROBOCOPY "%LocalAppdata%\qBittorrent" "%dsk%\Backup\%COMPUTERNAME%\Users\%USERNAME%".BKP\AppData\Local\qBittorrent /xf *.* /E /R:1 /W:0 /XJ /ZB
...
ROBOCOPY "%userprofile%" "%dsk%\Backup\%COMPUTERNAME%\Users\%USERNAME%".BKP\ /s /xjd /xjf /xd .metadata .receitanet .vec "Alfa Laval" AppData "Box Sync" Contacts Desktop Documents Downloads Dropbox Favorites GoogleDrive Links Music Onedrive Pictures "Saved Games" Skydrive Videos "VirtualBox VMs" /xf *.bak *.dat *.ini *.log* ntuser*.* *.pol *.regtrans-ms *.sys /E /R:1 /W:0 /XJ /ZB
